...
import com.perso.bank.config.LocalDateTimeConfig;
...
public class OperationService {
	...
	@Autowired
	private LocalDateTimeConfig localDateTimeConfig;
	
	public List<OperationDTO> getWithDate(String date){
		
		LocalDateTime startDate = LocalDateTime.parse(date , localDateTimeConfig.getDateTimeFormatter() ).withDayOfMonth(1);
